...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2023 a las 06:39:44
...
(4, 'Un Chiringo entre el bosque y la montaña', 'Cabaña de montaña, que consta de 1 ambiente en planta baja con cocina-comedor, equipado con heladera, anafe a gas, horno eléctrico, jarra eléctrica y vajilla para 4 personas. El baño ubicado en planta baja tiene ducha con mampara. En este ambiente hay un futón cama donde pueden d', 30750, 3, 2, 'Tierra del Fuego', 'Ushuaia', 'Av. Los Olivos 222'),
(5, 'Departamento en Buesos Aires', 'Espectacular apartamento de tres ambientes en Villa Crespo, muy bien conectado y cerca de Palermo.Torre con amenities y todas las comodidades de una casa: jardin, piscina, cancha de futbol, mucho verde y seguridad 24 hs. Espacios amplios, luminosos y equipados. Tiene escritorio d', 33750, 3, 4, 'Buenos Aires', 'Ciudad Autónoma Buenos Aires', 'La Fé 554'),
...
(8, 'Vieja casona en un pequeño pueblo', 'A tan solo 25 kilómetros al oeste de la ciudad de Tucumán se encuentra, enclavada entre los cerros y la selva, la hermosa y pintoresca localidad de Villa Nougués.', 28000, 3, 3, 'Tucumán', 'Villa Nougués', 'San Martin 212'),
...
(22, 'casas saladas', 'zvdzfbxnnv,mnzxxcnnnhchmmvmvm', 333333, 2, 5, 'Cordoba', 'carlos paz', 'Av. Siempre viva 234');
...
(5, 'mart', 'lopez', 'marta@gmail.com', '$2a$10$PEvSaimtqJP4gAtQsbF9LOjkdwUR5O6Dt4mQigm3VXSZqbIQ/ZayG', '123123', 'women-default.png', 3885123123, '2222-12-02', '');
...
--
ALTER TABLE `images_lodging`
  MODIFY `id_image` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `lodging`
  MODIFY `id_lodging` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
